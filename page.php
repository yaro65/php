...
<div class="card">
  <div class="card2">
    ...
    <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
      ...
      <input type="date" class="input-field" name="age" placeholder="age", required>
    </div>
    <div class="btn">
    <input type="submit" class="button1" value="envoyer" name="envoyer">
    <button class="button2">connectez-vous</button>
    </div>
    <button class="button3">Mot de passe </button>
</form>
  </div>
    </div>
